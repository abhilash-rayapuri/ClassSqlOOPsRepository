class EmpService:
    ...
    def insert_employee(self, employees):
        return self.emp_repository.insert_employee(employees)

    def get_employee(self, emp_id):
        return self.emp_repository.fetch_employee(emp_id)

    def update_employee(self, employees):
        return self.emp_repository.update_employee(employees)
    ...
    def get_employees_by_deptNo(self, dep_id):
        return self.emp_repository.get_employees_by_deptNo(dep_id)
